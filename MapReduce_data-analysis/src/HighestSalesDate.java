...
public class HighestSalesDate {
    ...
    public static class SalesMapper extends Mapper<LongWritable, Text, Text, DoubleWritable> {
        ...
        public void map(LongWritable key, Text value, Context context) 
            ...
            try {
                ...
                context.write(orderDate, salesAmount);
        ...
        public void map(LongWritable key, Text value, Context context) 
            ...
            try {
                ...
                if (parts.length == 2) {
                    ...
                    context.write(new Text("max"), new Text(date + ":" + amount));
                }
            } catch (Exception e) {
    ...
    public static class MaxReducer extends Reducer<Text, Text, Text, DoubleWritable> {
        ...
        public void reduce(Text key, Iterable<Text> values, Context context) 
            ...
            context.write(new Text(maxDate), new DoubleWritable(maxAmount));
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length != 3) {
            System.err.println("Usage: HighestSalesDate <input> <temp_output> <final_output>");
            System.exit(-1);
        }
        
        Configuration conf1 = new Configuration();
        
        Job job1 = Job.getInstance(conf1, "Calculate Sales Per Date");
        job1.setJarByClass(HighestSalesDate.class);
        ...
        Job job2 = Job.getInstance(conf2, "Find Highest Sales Date");
        job2.setJarByClass(HighestSalesDate.class);
